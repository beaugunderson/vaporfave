...
var ImageHelper = require('./lib/image-helper.js');
var ImageLine = require('./lib/image-line.js');
var ImageRays = require('./lib/image-rays.js');
var Rainbow = require('./lib/rainbow.js');
var SequentialImageSet = require('./lib/sequential-image-set.js');

var rotations = require('./lib/rotation-functions.js');
...
EccoJam.prototype.drawErrorMessage = function () {
  ...
  this.context.font = '11px Microsoft Sans Serif';

  this.context.fillText('Exception in misandry.dll:', x + 58, y + 43);
  this.context.fillText('Missing __UnicodeW@55325', x + 58, y + 59);
};
