...
var utilities = require('canvas-utilities/lib/utilities.js');
...
EccoJam.prototype.drawWithinBounds = function (imageHelper) {
  ...
  imageHelper.draw(_.random(0, this.width - (scaledWidth / 2)),
                   _.random(0, this.height - (scaledHeight / 2)),
                   scaledWidth,
                   scaledHeight);
};
